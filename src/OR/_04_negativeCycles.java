...
/**
 *האם קיימים מעגלים שליליים בגרף (גרף לא מכוון ומכווון)?
 *
 * אם כן, לתת דוגמא למעגל שלילי
 *
 * מציאת תת מערך קצר ביותר עם סכום מקסימלי בעזרת מטריצה O(n^3) - חיפוש שלם אין קוד
 *
 *אין קוד מציאת תת מערך קצר ביותר עם סכום מקסימלי בעזרת מטריצה O(n^2) - חיפוש שלם חכם תכנון דינאמי
 */
