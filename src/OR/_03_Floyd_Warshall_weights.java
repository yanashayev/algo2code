...
/**
 * מציאת מטריצת המרחקים עם משקלים על הצלעות
 *
 * מציאת המסלולים הזולים ביותר מכל קודקוד לכל קודקוד
 *
 * משקלים על קודקודים
 *
 * מחשבה: משקלים על קודקודים וצלעות
 *
 * (לבקשת הסטודנטים) הרעיון של דייקסטרה ללא אלגוריתם פורמלי
 *
 * תוספת תכנות: שיפור של בעית הבקבוקים למסלולים זולים ביותר
 */
