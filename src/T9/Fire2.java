...
public class Fire2 {
    public static void fire2(ArrayList<Integer>[] tree){
        int n = tree.length;
    ...
    public static void main(String[] args) {
        fire2(InitTreesAl.initTree1());//radius = 3, diameter = 5, centers: 1, 4
        fire2(InitTreesAl.initTree2());//radius = 2, diameter = 4, centers: 2
        fire2(InitTreesAl.initTree3());//radius = 4, diameter = 7, centers: 3, 4
        fire2(InitTreesAl.initTree4());//radius = 3, diameter = 5, centers: 2, 5
        fire2(InitTreesAl.initTree5());//radius = 3, diameter = 5, centers: 2, 4
        fire2(InitTreesAl.initTree6());//radius = 1, diameter = 2, centers: 0
        fire2(InitTreesAl.initTree7());//radius = 2, diameter = 3, centers: 1, 2
    }
