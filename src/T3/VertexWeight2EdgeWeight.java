...
/**
 * page 6 back !!!!! make it edge weight by ver weight
 */
public class VertexWeight2EdgeWeight {
    ...
    public static void checkFWVertecesWeightToEdgesWeght(){
        ...
        boolean mb[][] = initB1(); //initial neighber mat
        int [] weVert = {1,2,3,4}; //array of vertex
        ...
        printMatrix(edgeWeightMatrix2VertexWeightMatix(weVert, mat));//page7
